def numerologo():
    '''Significado do número gerado pela soma dos valores atribuidos as letras do nome'''
    # lista das letras
    letra_list = list(map(lambda l: chr(l), range(ord("A"), ord("Z")+1)))
    ...
    num = list(map(lambda l: letra_dict[l], nome_list))
